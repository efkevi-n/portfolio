...
function Project({
  ...
  return (
    <article className=" bg-gray-200 max-w-[42rem] boder border-black/[5] overflow-hidden sm:pr-8 relative sm:h-[20rem]">
    ...
    <h3 className="text-2xl font-semibold">{title}</h3>
      ...
      <Image src={imageUrl} alt="projects" quality={100} className= "absolute top-8 -right-40 w-[28.3rem] rounded-t-lg shadow-2xl"/>
    </article>
  );
}
