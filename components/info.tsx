  ...
  return (
    ...
    className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem] ">
      ...
      >
        ...
        <a className="bg-white flex group items-center gap-2 rounded-full px-7 py-3 outline-none focus:scale-110 hover:scale-110 active:scale-105 transition cursor-pointer shadow border border-black/10 dark:bg-white/10" href="/public/CV.pdf" download>Download CV <HiDownload className="opacity-60 group-hover:translate-y-1 transition"/> </a>
       ...
       <a className="bg-white flex items-center gap-2 rounded-full p-4 text-gray-700 shadow border border-black/10 focus:scale-[1.15] hover:scale-[1.15] active:scale-105 transition cursor-pointer hover:text-gray-950  dark:bg-white/10 dark:text-white/60  " href="https://github.com/efkevi-n" target="_blank" >
       <BsGithub />
        </a> 

       <a  className="bg-white flex items-center gap-2 rounded-full p-4 text-gray-700 shadow border border-black/10 focus:scale-[1.15] hover:scale-[1.15] active:scale-105 transition cursor-pointer hover:text-gray-950 dark:bg-white/10 dark:text-white/60 " href="https://twitter.com/efkevin_" target="_blank">
       <BsTwitter />
        </a>
      </motion.div>
    </section>
